...
<tr>
<td rowspan="6" style="vertical-align : middle; text-align : center;"><img src="<?php echo $rows['avatar']; ?>" width="100px" height="100px" style="border-radius : 5px;"/><br>
<?php echo "".$rows['nama'];?>
</td>
<tr>
<td>Id User : <?php echo "".$rows['idu'];?></td>
</tr>
<tr>
<td>Nama : <?php echo "".$rows['nama'];?></td>
</tr>
<tr>
<td>Telephone : <?php echo "".$rows['nope'];?></td>
</tr>
<tr>
<td>E-Mail : <?php echo "".$rows['email'];?></td>	
</tr>
<tr>
<td>Website : <?php $web= $rows['web']; ?><?php echo "<a href='$web' target='blank'>".$rows['web']."</a>";?></td>
</tr>
</table>
</div>
&nbsp;
&nbsp;<center>
		<a href="editprofil.php" value="1" class="button edit">Edit Profile</a>
		<a href="gantiava.php" value="2" class="button add">Ganti Avatar</a>
		<a href="gantipassword.php" value="3" class="button edit">Ganti Password</a>
		</center>
&nbsp;
&nbsp;
<?php /* ----------------------------------------akhir awak----------------------------------- */ ?>
