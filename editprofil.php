...
<body>
	...
	<div class="wrapper">
		...
		<div class="shell">
			...
			<br>
<form method="post" action="editprofilkirim.php" enctype="multipart/form-data">
<?php 
	include "connect.php";
	$id = $_SESSION['id_user'];
...
<tr>
	<td>Nama Anda</td>
	<td><input type="text" name="nama" size="30" value="<?php echo $rows['nama']; ?>" /></td>
</tr>
<tr>
	<td>Telephone </td>
	<td><input type="text" name="nope" size="30" value="<?php echo $rows['nope']; ?>" /></td>
</tr>
<tr>
	<td>Email</td>
	<td><input type="text" name="email" size="30" value="<?php echo $rows['email']; ?>" /></td>
</tr>

<tr>
	<td>Website</td>
	<td><input type="text" name="web" size="30" value="<?php echo $rows['web']; ?>" /></td>
</tr>
<tr>
	<td colspan="2" align="center">
		<input type="submit" name="submit" class="button" value="perbaharui"/>
