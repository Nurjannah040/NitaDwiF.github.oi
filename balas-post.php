...
<form method="post" action="kirim-balas-post.php">
	<div>
		<!-- Gets replaced with TinyMCE, remember HTML in a textarea should be encoded -->
		<div style="margin:20px 20px 20px 25px; text-align:left; font-size:20px; font-family: Times New Roman;">
			BALAS TOPIK : <?php 
						$id = $_SESSION['id'];
		...
		<br />
		<input type="submit" name="save" value="Terbitkan" class="button"/>
...
<p align="center"><button class="button"><a onClick="self.history.back()"><b>Batal dan Kembali Ke Posting</b></a></button></p>
&nbsp;
<?php /* ----------------------------------------akhir awak----------------------------------- */ ?>
				</section>
		...
		<div id="footer">
			...
			<div class="shell">
				...
				<div class="footer-bottom">
					...
					<p class="copy">Copyright &copy; 2012 FDtekMIRA<span>|</span>Design by: <a href="http://chocotemplates.com" target="_blank">www.ChocoTemplates.com</a></p>
					<div class="cl">&nbsp;</div>
				</div>
			</div>
			<!-- end of shell -->
