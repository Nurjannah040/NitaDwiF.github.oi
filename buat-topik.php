		...
		<div class="shell">
			...
			<div class="main">
				<section class="content">
					<center><h2>BUAT TOPIK</h2></center>
				<?php /*----------------------------------------awal awak----------------------------------- */ ?>
...
<p align="center"><button class="button"><a onClick="self.history.back()"><b>Batal dan Kembali Ke Topik</b></a></button></p>
&nbsp;
<?php /* ----------------------------------------akhir awak----------------------------------- */ ?>
				</section>
