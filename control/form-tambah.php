...
<h1>Category</h1>
<ol class="breadcrumb">
              <li class="active"><i class="fa fa-wrench"></i> Lengkapi Pendaftaran Kategori Baru !</li>
            </ol>
<?php $idk=$_GET['idk'];
$_SESSION['idk']= $idk;
...
<div class="table-responsive">
	...
	<tr>
		<tr>
			...
			<td><b>Deskripsi Sub Kategori</b><font size="2px" ><p>Menggambarkan isi dari sub kategori, dengan maksud memberikan penjelasan</p><p>yang lebih terperinci dari nama sub kategori..</font></td><td> <textarea name="deskripsi" rows="5" cols="46"><?php echo $rows['detail'];?></textarea></td>
		</tr>
		<tr>
