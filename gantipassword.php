...
<form method="post" action="gantipasswordkirim.php" enctype="multipart/form-data">
				&nbsp;
				&nbsp;
<?php /* ----------------------------------------awal awak----------------------------------- */ ?>
<center>
...
<tr>
	<td>Password Baru</td>
	<td><input type="password" name="password_baru" id="password_baru" size="30" value="" /></td>
</tr>
<tr>
	<td>Ketik Ulang</td>
	<td><input type="password" name="ketik_ulang" id="ketik_ulang" size="30" value="" /></td>
</tr>
<tr>
	<td colspan="2" align="center">
		<input type="submit" name="submit" class="button" id="submit_btn" value="perbaharui"/>
