		...
		<div class="shell">
			...
			<div class="main">
				<section class="content">
					<h2>Edit Topik</h2>
					<p>Silahkan edit topik sesuai dengan yang anda inginkan</p>
<?php /* ----------------------------------------awal awak----------------------------------- */ ?>
...
<form method="post" action="kirim-edit-topik.php">
<?php
include "connect.php";
$id = $_GET['post'];
$_SESSION['id'] = $id;
...
?>
	<div>
		...
		<div style="margin:20px 20px 20px 25px; text-align:left; font-size:20px; font-family: Times New Roman;">
			JUDUL <input type id="judul" name="judul" size="80" value="<?php echo $rows['judul']; ?>"/>
		</div>
		<div class="text">
			<textarea id="text" name="text" rows="20" cols="120" style="width: 95%">
			<?php echo $rows['posting']; ?>
			</textarea>
		</div>
		<br />
